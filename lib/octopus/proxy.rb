...
module Octopus
  class Proxy
    ...
    def delete(*args, **kwargs, &block)
      legacy_method_missing_logic('delete', *args, **kwargs, &block)
    end
    ...
    def select_value(*args, **kwargs, &block)
      legacy_method_missing_logic('select_value', *args, **kwargs, &block)
    end
    ...
    def respond_to_missing?(method, include_private = false)
      select_connection.respond_to?(method, include_private) || super
    end
    ...
    def legacy_method_missing_logic(method, *args, **kwargs, &block)
      if should_clean_connection_proxy?(method)
        ...
        merged_kwargs = preparable.nil? ? kwargs : kwargs.merge(preparable)
        select_connection.send(method, *args, **merged_kwargs, &block)
        ...
        args, preparable = handle_args(args)
        merged_kwargs = preparable.nil? ? kwargs : kwargs.merge(preparable)
        val = select_connection.send(method, *args, **merged_kwargs, &block)
